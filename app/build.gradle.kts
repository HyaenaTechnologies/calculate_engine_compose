...
dependencies {
    ...
    testImplementation("io.ktor:ktor-client-tests:2.3.8")
    testImplementation("io.ktor:ktor-client-content-negotiation-tests:2.3.8")
    testImplementation("io.ktor:ktor-serialization-tests:2.3.8")
    testImplementation("io.ktor:ktor-serialization-kotlinx-tests:2.3.8")
